...
void
MEventObj::AssignMgr(
    MEventMgrPtr & Parent)         // parent to manage this object
{
    ...
    {
        Logging(LOG_ERR, "%s: param error invalid MEventMgr",
                __func__);
    }   // else
    ...
    const std::chrono::milliseconds & Interval)
{
  ...
  if (!ret_flag)
  {
    Logging(LOG_ERR,"%s: unable to add timer to list",
            __func__);
  }   // if
