...
protected:
    std::vector<iovec> m_ResponsePDUVec;    //!< m_Header [0], PduResponse[1], variable data
    std::vector<iovec> m_ResponsePDUVecCopy;//!< working copy used during actual xmit
...
private:
    ...
    ResponsePDU & operator=(const ResponsePDU &);  //!< disabled:  assignment operator
};  // class ResponsePDU
