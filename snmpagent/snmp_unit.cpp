...
public:
  objAgentOpen(SnmpAgentId &AgentId, unsigned IpHostOrder,
               unsigned PortHostOrder, StartupListObject **Startup = NULL)
 ...
 */
void SnmpAgentTester::testAgentOpen() {
  MEventMgr mgr;
  const unsigned agent_prefix[] = {1, 38693, 1, 3};
  SnmpAgent::SnmpAgentId id = {agent_prefix,
                               sizeof(agent_prefix) / sizeof(agent_prefix[0]),
                               "SnmpAgentTester"};
...
void SnmpAgentTester::testGauge32() {
