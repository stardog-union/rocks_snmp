 ...
 *
 * @brief Implemenation of snmp agentX response pdu object (rfc 2741, January 2000)
 */
...
ResponsePDU::WriteIovec()
{
    ...
    AdjustIovec(&m_ResponsePDUVecCopy.at(0), m_ResponsePDUVecCopy.size(), m_ResponsePDUSent);
