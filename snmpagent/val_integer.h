...
public:
  ...
  SnmpValUnsigned32 &assign(unsigned UValue) {
    m_Unsigned = UValue;
    return (*this);
  };
...
private:
  ...
  SnmpValUnsigned32 &
  operator=(const SnmpValUnsigned32 &); //!< disabled:  assignment operator

}; // SnmpValUnsigned32

typedef std::shared_ptr<class SnmpValUnsigned32> SnmpValUnsigned32Ptr;

class SnmpValStaticUnsigned32
    : /*public StartupListObject,*/ public SnmpValUnsigned32 {
public:
  SnmpValStaticUnsigned32(/*StartupListObject ** RootPointer,*/ SnmpOid &Oid,
                          VarBindHeader &UnsignedType)
      : /*StartupListObject(RootPointer),*/ SnmpValUnsigned32(Oid,
                                                              UnsignedType){};

private:
  SnmpValStaticUnsigned32(); //!< disabled:  default constructor
  SnmpValStaticUnsigned32(
      const SnmpValStaticUnsigned32 &); //!< disabled:  copy operator
  SnmpValStaticUnsigned32 &operator=(
      const SnmpValStaticUnsigned32 &); //!< disabled:  assignment operator

}; // SnmpValStaticUnsigned32

class SnmpValInteger : public SnmpValUnsigned32 {
public:
  SnmpValInteger(const SnmpOid &Oid) : SnmpValUnsigned32(Oid, gVarInteger){};
...
private:
  ...
  SnmpValInteger &
  operator=(const SnmpValInteger &); //!< disabled:  assignment operator
...
private:
  ...
  SnmpValStaticGauge32(
      const SnmpValStaticGauge32 &); //!< disabled:  copy operator
  SnmpValStaticGauge32 &
  operator=(const SnmpValStaticGauge32 &); //!< disabled:  assignment operator

}; // SnmpValStaticGauge32

class SnmpValGauge32 : public SnmpValUnsigned32 {
public:
  SnmpValGauge32(const SnmpOid &Oid) : SnmpValUnsigned32(Oid, gVarGauge32){};
...
private:
  ...
  SnmpValGauge32 &
  operator=(const SnmpValGauge32 &); //!< disabled:  assignment operator
