...
public:
    ...
    {char buf[65]; snprintf(buf,65,"%lu", m_Unsigned64); Output=buf; return(Output);};

    /// ValueFactory support ... make everyone accept string input
    virtual void assign(const char *String)
    {if (NULL!=String) m_Unsigned64=strtoull(String, NULL, 10);};

    uint64_t operator++() {return(++m_Unsigned64);};

    SnmpValUnsigned64 & assign(uint64_t UValue64) {m_Unsigned64=UValue64; return(*this);};

    SnmpValUnsigned64 & assign(unsigned UValue) {m_Unsigned64=(uint64_t)UValue; return(*this);};
...
private:
    ...
    SnmpValUnsigned64 & operator=(const SnmpValUnsigned64 &);  //!< disabled:  assignment operator
...
class SnmpValStaticUnsigned64 : /*public StartupListObject,*/ public SnmpValUnsigned64
{
public:
SnmpValStaticUnsigned64(/*StartupListObject ** RootPointer,*/ SnmpOid & Oid, VarBindHeader & UnsignedType)
    : /*StartupListObject(RootPointer),*/ SnmpValUnsigned64(Oid, UnsignedType) {};


private:
    SnmpValStaticUnsigned64();                                          //!< disabled:  default constructor
    SnmpValStaticUnsigned64(const SnmpValStaticUnsigned64 & );             //!< disabled:  copy operator
    SnmpValStaticUnsigned64 & operator=(const SnmpValStaticUnsigned64 &);  //!< disabled:  assignment operator
...
public:
    SnmpValCounter64()
        : SnmpValUnsigned64(gVarCounter64) {};
...
private:
    ...
    SnmpValCounter64 & operator=(const SnmpValCounter64 &);  //!< disabled:  assignment operator
...
public:
    ...
    {if (NULL==m_Unsigned64Ptr) m_Unsigned64Ptr=&m_Unsigned64;};
    ...
    void SetPointer(uint64_t * Pointer) {if (NULL!=Pointer) m_Unsigned64Ptr=Pointer;};

private:
    SnmpValCounterPtr64();                                          //!< disabled:  default constructor
    SnmpValCounterPtr64(const SnmpValCounterPtr64 & );             //!< disabled:  copy operator
    SnmpValCounterPtr64 & operator=(const SnmpValCounterPtr64 &);  //!< disabled:  assignment operator
